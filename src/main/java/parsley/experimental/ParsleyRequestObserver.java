...
public class ParsleyRequestObserver {
	...
	public void didHandleRequest( NSNotification notification ) {
		if( !errors.get().isEmpty() ) {
			String errorDiv = """
					<div style="width: 100%%; height: 100px; position: absolute; top: 0px; right: 0px; background-color: rgba(255,0,0,0.6); border-bottom: 2px solid red; color: white; padding: 30px; text-align: center">
						<h2>%s %s errors on page</h2>
					</div>
